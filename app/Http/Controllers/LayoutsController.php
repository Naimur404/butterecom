...
class LayoutsController extends Controller
{
    ...
    public function sidebarDark()
    {
        return Inertia::render('admin/layouts/sidebar-dark/index');
    }
    ...
    public function topbarLight()
    {
        return Inertia::render('admin/layouts/topbar-light/index');
    }
}