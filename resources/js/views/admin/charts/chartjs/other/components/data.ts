    ...
    datasets: [
      {
        label: 'Dataset 1',
        data: [12, 19, 14, 15, 20],
        backgroundColor: [getColor('chart-primary'), getColor('chart-secondary'), getColor('chart-delta'), getColor('chart-gray'), getColor('chart-primary-rgb', 0.5)],
        borderColor: [getColor('chart-primary'), getColor('chart-secondary'), getColor('chart-delta'), getColor('chart-gray'), getColor('chart-primary-rgb', 0.1)],
        borderWidth: 2,
      },
    ],
  },
