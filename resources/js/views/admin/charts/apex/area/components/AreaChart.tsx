...
export const IrregularTimeSeries = () => {
  return <ApexChart getOptions={getAreaTimeSeriesChart} series={getAreaTimeSeriesChart().series} type="area" height={380} />
}

export const AreaWithNullValues = () => {
  return <ApexChart getOptions={getAreaChartWithNullValues} series={getAreaChartWithNullValues().series} type="area" height={380} />
}
