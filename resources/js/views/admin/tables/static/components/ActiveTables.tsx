    ...
    <>
      <Card>
        <CardHeader className="justify-content-between">
          <CardTitle as="h4"> Active Tables </CardTitle>
          <Link href="https://getbootstrap.com/docs/5.3/content/tables/#active-tables" target="_blank" className="icon-link icon-link-hover link-secondary link-underline-secondarlink-secondary link-underline-opacity-25 fw-semibold">
            View Docs
          ...
          <Table responsive className="align-middle mb-0">
            ...
            <tbody>
              {productsTable.data.slice(0, 3).map((product, idx) => (
                <tr className={idx === 0 ? 'table-active' : ''} key={idx}>
                  <td>{product.name}</td>
