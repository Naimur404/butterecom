    ...
    <>
      <Card>
        <CardHeader className="justify-content-between">
          <CardTitle as="h4"> Bordered Tables </CardTitle>
          <Link href="https://getbootstrap.com/docs/5.3/content/tables/#bordered-tables" target="_blank" className="icon-link icon-link-hover link-secondary link-underline-secondarlink-secondary link-underline-opacity-25 fw-semibold">
            View Docs
            <Icon icon="arrow-right" className="bi align-middle fs-lg"></Icon>
          </Link>
        </CardHeader>
        <CardBody>
          <Table responsive className="table-bordered align-middle mb-0">
