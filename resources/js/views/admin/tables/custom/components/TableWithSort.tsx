...
const TableWithSort = () => {
  ...
  return (
    <>
      <Card>
        <CardHeader>
          <CardTitle as="h4">Custom table with sort</CardTitle>
        </CardHeader>
        ...
        <CardHeader className="border-light justify-content-between">
          ...
          <div className="d-flex align-items-center gap-2">
            ...
            <div className="app-search">
              ...
              <Icon icon="layout-grid" className="app-search-icon text-muted" />
            </div>
            {/* Stock Filter */}
            <div className="app-search">
            ...
            {/* Price Range Filter */}
            <div className="app-search">
              <FormSelect className="form-control my-1 my-md-0" value={(table.getColumn('price')?.getFilterValue() as string) ?? ''} onChange={(e) => table.getColumn('price')?.setFilterValue(e.target.value || undefined)}>
