...
const ShippingAddress = () => {
  return (
    <Card>
      ...
      <CardBody>
        <iframe src="https://www.google.com/maps/embed/v1/place?q=New+York+University&key=REDACTED_GOOGLE_MAPS_API_KEY" style={{ width: '100%', height: 180, overflow: 'hidden', border: 0 }} />
