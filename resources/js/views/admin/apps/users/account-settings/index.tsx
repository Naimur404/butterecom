import profile from '@/images/profile-bg.jpg'
      ...
      <Row>
        <Col xs={12}>
          <Card className="overflow-hidden mb-0">
            <div className="position-relative card-side-img overflow-hidden" style={{ minHeight: 300, backgroundImage: `url(${profile})` }}>
