...
import gallery1 from '@/images/gallery/10.jpg'
    ...
    <Card>
      <CardBody className="pb-2">
        ...
        <div className="mt-2">
          ...
          <span className="btn btn-sm fs-sm btn-link text-muted" onClick={() => setLiked(!liked)} style={{ cursor: 'pointer' }}>
            {liked ? (
  ...
  return (
    <Card>
      <CardBody className="text-center">
        ...
        <Link href="/apps/users/profile" className="btn btn-sm btn-primary">
