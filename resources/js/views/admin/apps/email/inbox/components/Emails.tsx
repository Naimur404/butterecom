                  ...
                  <tr className={`position-relative ${email.isRead ? 'mark-as-read' : ''}`} key={email.id}>
                    <td className="ps-3" style={{ width: '1%' }}>
                      <div className="d-flex gap-3">
                        ...
                        <button className="btn p-0  fs-xl">{email.isStarred ? <Icon icon="star" className="text-warning" /> : <Icon icon="star" className="text-muted" />}</button>
                      </div>
                    </td>
                    <td>
                    ...
                    <td>
                      <Link href="/apps/email/details" className="link-reset fs-base fw-medium stretched-link">
                        {email.subject}
                      </Link>
