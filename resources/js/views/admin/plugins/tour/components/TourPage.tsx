        ...
        <Row className="justify-content-center">
          <Col lg={5}>
            <div className="text-center mt-4 mb-5">
              ...
              <p className="text-muted fs-sm">Build modern web applications faster with our feature-rich admin panel. Compatible with multiple frameworks and packed with diverse demos, it offers seamless customization and a consistent UI across all your projects.</p>
              ...
              <div className="d-flex justify-content-center mt-4 flex-wrap gap-2">
                ...
                >
                  <Icon icon="play" className="me-1" /> Start Guided Tour
                </Button>

                <Link ref={step1Ref} href="" className="btn btn-dark">
                  <Icon icon="compass" className="me-1" /> Discover Features
                </Link>

                <Link ref={step2Ref} href="" target="_blank" className="btn btn-danger">
                  <Icon icon="shopping-cart" className="me-1" /> Get the Template
                </Link>
              </div>
            </div>
          </Col>
                ...
                <Card className="border-0 p-2 card-h-100">
                  ...
                  <CardFooter className="border-0 pt-0">
                    <Link className="link-primary fw-semibold" href="">
                      Know more <Icon icon="arrow-right" className="ms-2 align-middle" />
                    </Link>
                  </CardFooter>
                </Card>
              </Col>
