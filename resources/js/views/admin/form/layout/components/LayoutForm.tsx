...
import { Button, Card, CardBody, CardHeader, CardTitle, Col, FloatingLabel, Form, FormCheck, FormControl, FormGroup, FormLabel, FormSelect, FormText, InputGroup, Modal, ModalBody, Row } from 'react-bootstrap'
...
const BasicForm = () => (
  <>
    <Card>
      <CardHeader>
        <CardTitle as={'h4'}>Basic Form</CardTitle>
      </CardHeader>
      <CardBody>
          ...
          <Col sm={6} className="text-center">
            <div className="avatar avatar-xl mx-auto">
              <span className="avatar-title bg-purple-subtle text-purple rounded-circle fw-bold">
                <Icon icon="shield-user" className="text-purple fs-28 fill-purple" />
              </span>
            </div>
            ...
            <Link href="/auth/sign-up" className="link-primary text-decoration-underline fw-semibold link-offset-3">
              Create Your Account
            </Link>
          </Col>
        </Row>
...
const ModalForm = () => {
  ...
  return (
    <>
      <Card>
        <CardHeader>
          <CardTitle as={'h4'}>Modal Form</CardTitle>
        </CardHeader>
        <CardBody>
          ...
          <Modal className="fade" show={show} onHide={toggle} size="lg">
            <ModalBody>
              <Row className="g-4 align-items-center">
                <Col sm={6} className="border-end border-dashed">
                  <div className="p-4">
...
const HorizontalForm = () => {
  return (
    <>
      <Card>
        <CardHeader>
          <CardTitle as={'h4'}>Horizontal Form</CardTitle>
        </CardHeader>
        <CardBody>
...
const HorizontalFormLabelSize = () => {
  return (
    <>
      <Card>
        <CardHeader>
          <CardTitle as="h4">Horizontal Form Label Sizing</CardTitle>
        </CardHeader>
        <CardBody>
          <Form>
            <Row className="mb-2">
...
const InlineForm = () => {
  return (
    <>
      <Card>
        <CardHeader>
          <CardTitle as={'h4'}>Inline Form</CardTitle>
        </CardHeader>
        <CardBody>
          <Form>
...
const FormRow = () => {
  return (
    <>
      <Card>
        <CardHeader>
          <CardTitle as={'h4'}>Form Row</CardTitle>
        </CardHeader>
        <CardBody>
          <Form>
            <Row className="g-2">
