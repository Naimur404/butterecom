...
import { Alert, AlertHeading, Button, Col, Row } from 'react-bootstrap'
...
const DefaultAlert = () => {
  return (
    <ComponentCard title="Default Alert" isCollapsible>
      ...
      <Alert variant="dark" role="alert" className="mb-0">
...
const DismissingAlert = () => {
  return (
    <ComponentCard title="Dismissing Alert with Solid Colors" isCollapsible>
      <Alert variant="primary" dismissible className="text-bg-primary" closeVariant="white">
        <div>Heads up! This is a primary alert with important information.</div>
      </Alert>
      <Alert variant="secondary" dismissible className="text-bg-secondary" closeVariant="white">
        <div>Notice: This is a secondary alert with supporting details.</div>
      </Alert>
      <Alert variant="success" dismissible className="text-bg-success" closeVariant="white">
        <div>Success! Your action was completed successfully.</div>
      </Alert>
      <Alert variant="danger" dismissible className="text-bg-danger" closeVariant="white">
        <div>Error! Something went wrong—please try again later.</div>
      </Alert>
      <Alert variant="warning" dismissible className="text-bg-warning" closeVariant="white">
        <div>Warning! Please review your input before proceeding.</div>
      </Alert>
      <Alert variant="info" dismissible className="text-bg-info" closeVariant="white">
      ...
      <Alert variant="dark" dismissible className="text-bg-dark mb-0" closeVariant="white">
  ...
  return (
    <ComponentCard title="Additional Content" isCollapsible>
      ...
      <Alert variant="secondary" className="p-3 d-flex">
        <Icon icon="alarm-clock" className="fs-1 me-2" />
        <div>
      ...
      <Alert variant="danger" className="d-flex p-3 mb-0">
        <Icon icon="phone-call" className="fs-1 me-2" />
        <div>
  ...
  return (
    <ComponentCard title="Custom Alerts" isCollapsible>
      ...
      <Alert variant="info" dismissible className="d-flex align-items-center gap-2" role="alert">
        <Icon icon="octagon-alert" className="fs-xl" /> An info alert with a custom icon!
      </Alert>

      <Alert variant="light" className="border-2 d-flex align-items-center p-3 mb-0" role="alert">
        <Icon icon="phone-call" className="text-success fs-2 me-3" />
        <div>
          <AlertHeading as="h4">Notice!</AlertHeading>
