...
const CardWithActionTools = () => {
  return (
    <ComponentCard title="Card with Action Tools" isCollapsible isRefreshable isCloseable>
      <p className="card-text">With supporting text below as a natural lead-in to additional content.</p>
      <Link href="" className="btn btn-sm btn-primary">
        Go somewhere
      </Link>
...
const CardWithActionToolsBgColor = () => {
  return (
    <ComponentCard className="text-bg-primary border-0" cardTitleClassName="text-white" title="Card with Action Tools &amp; Background Colors" isCollapsible isRefreshable isCloseable>
