  ...
  return (
    <ComponentCard title="Color & Background" isCollapsible>
      <p className="text-muted">
        ...
        <code>.text-*</code> utilities and <code>.bg-*</code> utilities in one class. Using our Sass <code>color-contrast()</code> function, we automatically determine a contrasting <code>color</code> for a particular <code>background-color</code>.
      </p>
...
const BackgroundOpacity = () => {
  return (
    <ComponentCard title="Background Opacity" isCollapsible>
      <p className="text-muted">
        <code>background-color</code> utilities are generated with Sass using CSS variables. This allows for real-time color changes without compilation and dynamic alpha transparency changes.
      </p>
...
const BorderRadiusSize = () => {
  return (
    <ComponentCard title="Border Radius Size" isCollapsible>
      <p className="text-muted">
    ...
    <ComponentCard title="Overflow" isCollapsible>
      ...
      <div className="d-flex flex-wrap gap-4">
        ...
        <div className="overflow-visible p-3 bg-light" style={{ maxWidth: 260, maxHeight: 100 }}>
          This is an example of using <code>.overflow-visible</code> on an element with set width and height add more text dimensions admin dashboard template.
        </div>
  ...
  return (
    <ComponentCard title="Width" isCollapsible>
      <p className="text-muted">
        ...
        <code>box-shadow</code> utility classes. Includes support for <code>.shadow-none</code> and three default sizes (which have associated variables to match).
      </p>
  ...
  return (
    <ComponentCard title="Object Fit" isCollapsible>
      <p className="text-muted">
        ...
        with our responsive <code>object-fit</code> utility classes. This property tells the content to fill the parent container in a variety of ways, such as preserving the aspect ratio or stretching to take up as much space as possible.
      </p>
