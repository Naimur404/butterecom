    ...
    <ComponentCard title="Basic" isCollapsible>
      ...
      <p className="mb-0">
        ...
        <OverlayTrigger placement="top" overlay={<Tooltip className="danger-tooltip">Manage your dashboard easily</Tooltip>}>
          <Link href="" className="fw-medium" data-bs-title="Manage your dashboard easily">
            custom dashboards
          </Link>
        </OverlayTrigger>
        ...
        <OverlayTrigger placement="top" overlay={<Tooltip className="danger-tooltip">Built with Bootstrap 5</Tooltip>}>
          <Link href="" className="fw-medium" data-bs-title="Built with Bootstrap 5">
            responsive design
          </Link>
        </OverlayTrigger>
        ...
        <OverlayTrigger placement="top" overlay={<Tooltip className="danger-tooltip">Tailored for developers</Tooltip>}>
          <Link href="" className="fw-medium" data-bs-title="Tailored for developers">
            UI toolkit
          </Link>
        </OverlayTrigger>
        ...
        <OverlayTrigger placement="top" overlay={<Tooltip className="danger-tooltip">Includes charts, tables, forms and more</Tooltip>}>
          <Link href="" className="fw-medium" data-bs-title="Includes charts, tables, forms and more">
            powerful components
          </Link>
        </OverlayTrigger>
