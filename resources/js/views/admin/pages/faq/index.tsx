            ...
            <Col lg={6} md={8}>
              <div className="text-center">
                ...
                <div className="d-flex justify-content-center gap-2 flex-wrap">
                  <Link href="mailto:support@example.com" className="btn btn-success">
                    <Icon icon="mail" className="fs-5 me-1" />
                    Contact Support
                  </Link>
                  <Link href="https://twitter.com/intent/tweet?text=Hello+Support" target="_blank" className="btn btn-primary">
